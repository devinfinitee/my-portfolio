<script lang="ts">
	...
	const projects = [
		...
		},
		{
			title: 'AirCambridge',
			description:
				'A premium private jet booking platform built for a client, featuring real-time flight tracking, luxury aircraft selection, and seamless booking experience.',
			image: 'https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=400&h=300&fit=crop',
			rating: 4,
			tech: ['React', 'Tailwind'],
			link: 'https://aircambridge.vercel.app',
			github: 'https://github.com/devinfinitee'
		},
		{
			title: 'Finguard',
			description:
				'A comprehensive fintech application for personal finance management, featuring expense tracking, budget planning, investment monitoring, and financial insights.',
		...
		},
		{
			...
			description:
				'A modern news aggregation platform with real-time updates, category filtering, and responsive design.',
		...
		},
		{
			...
			description:
				'An innovative AI-powered healthcare platform developed for a hackathon exhibition, featuring symptom analysis, health recommendations, and telemedicine integration.',
			image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=400&h=300&fit=crop',
			rating: 5,
			tech: ['React', 'Tailwind', 'Express', 'MongoDB', 'GeminiAPI'],
			link: 'https://yourhealthpal.vercel.app',
			github: 'https://github.com/devinfinitee'
		},
		{
			title: 'PrimeNest',
			description:
				'A polished real-estate demo where owners can showcase property listings with rich visuals and clear calls-to-action.',
			image:
				'https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=800&h=600&q=80',
			rating: 5,
			tech: ['React', 'Tailwind', 'FireBase'],
			link: 'https://primenest-beige.vercel.app',
			github: 'https://github.com/devinfinitee'
		},
		{
		...
		},
		{
			...
			description:
				'In-progress course marketplace where sellers can upload, price, and market their digital courses.',
			image:
...
<section id="projects" class="px-4 py-16 sm:py-20 lg:py-24">
	<div class="container mx-auto max-w-6xl px-4">
		<!-- Section Heading -->
		<div class="mb-8 sm:mb-12 lg:mb-16">
			<h2 class="projects-title mb-4 text-3xl font-bold text-white sm:text-4xl">Projects</h2>
			<p class="projects-description max-w-2xl text-base text-gray-300 sm:text-lg">
		...
		<!-- Projects Grid -->
		<div
			class="projects-grid grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 lg:gap-8"
		>
			{#each projects as project}
				<a
					...
					class="project-card group card-surface card-hover block cursor-pointer overflow-hidden rounded-xl transition-all duration-300"
				>
					<!-- Project Image -->
					<div
						class="project-image h-48 overflow-hidden"
					...
					<div class="p-4 sm:p-6">
						<div class="mb-3 flex items-start justify-between">
							<h3
								class="text-lg font-semibold transition-colors sm:text-xl"
							...
							<ExternalLink
								size={20}
								class="text-muted transition-colors"
